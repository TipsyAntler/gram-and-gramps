window.STORY_FEATURES={
  1:{
    ...
    photoNote:'Family archive photo from the period; exact identification/date is still being confirmed.',
  ...
  17:{
    ...
    photoNote:'A wonderfully on-theme family archive photo from roughly the same era; exact subject/date is still being confirmed.'
  },
  18:{
  ...
  26:{
    image:'https://drive.google.com/thumbnail?id=1KoYNYfRr_HRzNand59FvsZWySONmcmwL&sz=w1600',
    photoNote:'Family archive photo from roughly the dental-office era; exact identification/date is still being confirmed.',
